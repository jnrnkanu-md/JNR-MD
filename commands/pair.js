            ...
            return await sock.sendMessage(chatId, {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: '1203634282885430@newsletter',
        ...
        if (numbers.length === 0) {
            return await sock.sendMessage(chatId, {
                ...
                contextInfo: {
                    ...
                    isForwarded: true,
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: '12036342828475430@newsletter',
                        newsletterName: 'JNR NKANU CONCEPTS™',
                        serverMessageId: -1
                    }
                }
        ...
        for (const number of numbers) {
            ...
            await sock.sendMessage(chatId, {
                ...
                contextInfo: {
                    ...
                    isForwarded: true,
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: '12036342888475430@newsletter',
                        newsletterName: 'JNR NKANU CONCEPTS™',
                        serverMessageId: -1
                    }
                }
                ...
                if (response.data && response.data.code) {
                    ...
                    await sock.sendMessage(chatId, {
                        ...
                        contextInfo: {
                            ...
                            isForwarded: true,
                            forwardedNewsletterMessageInfo: {
                                newsletterJid: '1203634282875430@newsletter',
                                newsletterName: 'JNR NKANU CONCEPTS™',
                                serverMessageId: -1
                            }
                        }
